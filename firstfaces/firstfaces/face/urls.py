...
urlpatterns = [
    ...
    path('conversation/<int:session_id>', views.conversation, name="conversation"),
    ...
    path('store_conversation_over', views.store_conversation_over, name='store_conversation_over'),
