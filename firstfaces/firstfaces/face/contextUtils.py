...
def in_tri(POS,row):
	if (POS == row.POS_1 and row.POS_2 in okay_pos and row.POS_3 in okay_pos)or (POS == row.POS_2 and row.POS_1 in okay_pos and row.POS_3 in okay_pos) or (POS == row.POS_3 and row.POS_2 in okay_pos and row.POS_1 in okay_pos):
		return True
	else:
		return False
