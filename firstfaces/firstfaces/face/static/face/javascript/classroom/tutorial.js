...
function greeting17() {
    ...
    setTimeout( function() {
        ...
        tiaSpeak( "In your next class, when you click that button, a native English speaker will check your sentence. You will see if you made any mistakes in vocabulary or grammar.", needSendTTS=true, function() {
